/* ============================================================
   Smart21Brain Welcome page — Three.js interactive planets background
   Same solar-field system as the homepage Library section (rocky,
   banded gas giants, ocean worlds, ringed worlds, neon "cyber"
   worlds) drifting over a starfield, gently reacting to the mouse /
   touch cursor — sized to sit behind the welcome card, never on it.
   ============================================================ */
(function () {
  "use strict";

  function init() {
    var host = document.getElementById("welcomePlanetsCanvas");
    var section = host && host.closest(".welcome-shell");
